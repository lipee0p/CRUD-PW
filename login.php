...
<title>Acesso Seguro | Login</title>
...
<style>
        ...
        .login-input:focus {
            box-shadow: 0 0 0 2px #1a1c1d, 0 0 0 4px #facc15;
        }
    </style>
<style>
    body {
...
<!-- Shell: TopAppBar (Shared Component Logic) -->
...
<form action="index.php" class="flex flex-col gap-stack-gap" method="POST">
<!-- Email Field -->
...
<input class="login-input w-full bg-surface-container-highest/10 border-2 border-transparent text-surface px-12 py-4 rounded-xl font-body-md outline-none transition-all placeholder:text-surface-variant/20 focus:bg-on-background focus:border-primary-container" id="email" name="email" placeholder="nome@empresa.com" required="" type="email"/>
</div>
</div>
<!-- Password Field -->
<div class="flex flex-col gap-2">
...
<input class="login-input w-full bg-surface-container-highest/10 border-2 border-transparent text-surface px-12 py-4 rounded-xl font-body-md outline-none transition-all placeholder:text-surface-variant/20 focus:bg-on-background focus:border-primary-container" id="password" name="password" placeholder="••••••••" required="" type="password"/>
...
<p class="font-body-md text-body-md text-surface-variant/40 mb-4">
                ...
                <a class="text-surface font-bold border-b-2 border-primary-container ml-1" href="register.php">Cadastre-se</a>
</p>
...
<!-- Shell: BottomNavBar (Shared Component Contextual Rule: Suppressed on Login Screens) -->
<!-- Suppressed as per "Semantic Shell Mandate" for Task-Focused pages -->
<script>
        ...
        toggleBtn.addEventListener('click', () => {
            ...
            toggleBtn.querySelector('span').textContent = icon;
        });

        // Simple tactile interaction feedback
