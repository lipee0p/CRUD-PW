...
<!-- TopNavBar (Suppressed based on Transactional Rule, but keeping brand identity) -->
...
<input class="w-full bg-transparent border-none p-0 pb-4 text-on-surface placeholder:text-outline/50 focus:ring-0 font-body-md text-body-md" id="email" placeholder="nome@exemplo.com" type="email"/>
</div>
<!-- Password Input -->
<div class="group border-b border-outline-variant/30 focus-within:border-secondary transition-colors duration-300">
...
<input class="w-full bg-transparent border-none p-0 pb-4 text-on-surface placeholder:text-outline/50 focus:ring-0 font-body-md text-body-md" id="password" placeholder="••••••••" type="password"/>
</div>
</div>
...
<a class="font-label-md text-label-md text-secondary uppercase tracking-widest hover:underline underline-offset-8 transition-all" href="#">
                        Cadastre-se
                    </a>
</div>
</div>
...
<img alt="Barber shop interior" class="w-full h-full object-cover object-center grayscale-[0.2] contrast-[1.1]" data-alt="A cinematic, high-end barber shop interior captured in low-key lighting. The scene features vintage leather barber chairs, dark wood cabinetry, and polished chrome details. Moody, atmospheric shadows are contrasted by soft amber accent lighting illuminating artisan grooming tools. The overall aesthetic is one of quiet luxury, masculine sophistication, and meticulous craftsmanship, aligned with a deep navy and charcoal color palette." src="https://lh3.googleusercontent.com/aida-public/AB6AXuD91yb5uFbwglMM7W1d6xgHyLcQOh4GXLWHYP-3Uoog_pal7BHkF-loVGa_ROrszQcuLZIo6CgDu4wTqoRkH-fciMya8XnSxWGXRclmUHmSrqotjiociNlAad2x66YuzVkYKCePRPo3Tc9jxpW6f0Qo_UipSo7XAR-4ba5KvuMD9fqe5cShe9XFs58-Gko4rSmLlk35IE3pXhLJ5LlZOEcQ4yE0EjgDtUNpMrvnBUZfj-S4gqQuCty3RcQ4E7W0xnmxbkrW_oKCEjFo"/>
<!-- Atmospheric Overlay Text -->
...
<p class="font-body-lg text-body-lg text-secondary-fixed-dim/70"></p>
</div>
<!-- Texture Overlay -->
